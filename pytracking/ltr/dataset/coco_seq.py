...
from ltr.data.image_loader import jpeg4py_loader, jpeg4py_loader_w_failsafe
import torch
import random
...
class MSCOCOSeq(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, data_fraction=None, split="train", 
        ...
        if "coco_2014" in root:
            version = "2014"
        else:
            version = "2017"

        print("MSCOCOSeq", version)    
    ...
    def _get_frames_check(self, seq_id):
        path = self.coco_set.loadImgs([self.coco_set.anns[self.sequence_list[seq_id]]['image_id']])[0]['file_name']
