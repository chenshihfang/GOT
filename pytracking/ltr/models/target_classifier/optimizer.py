...
class DiMPSteepestDescentGN(nn.Module):
    ...
    def __init__(self, num_iter=1, feat_stride=16, init_step_length=1.0,
        ...
        ### clip
        # print("num_dist_bins", num_dist_bins) # 100
        # print("bin_displacement", bin_displacement) #0.1
        # input()
        ### clip
    ...
    def forward(self, weights, feat, bb, sample_weight=None, num_iter=None, compute_losses=True):
        ...
        ### clip
        # print("dist_map.shape", dist_map.shape) # 6 100 17 17
        # print("center.shape", center.shape) # 6 2
        # print("output_sz", output_sz) # 17 17
        # input()
        # for idx, ts in enumerate(dist_map[0]):
        #     heat_show(ts, "dist_map" + str(idx))
        ###
        ...
        ### clip
        # print("label_map.shape", label_map.shape) # 3 2 17 17
        # print("target_mask.shape", target_mask.shape) # 3 2 17 17
        # print("spatial_weight.shape", spatial_weight.shape) # 3 2 17 17
        # for idx, ts in enumerate(label_map[0]):
        #     heat_show(ts, "label_map" + str(idx))
        ###
        ...
        ### clip
        # print("scores.shape", scores.shape) # 3 2 17 17
        # for idx, ts in enumerate(scores[0]):
        #     heat_show(ts, "scores" + str(idx))
        ###
