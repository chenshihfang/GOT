...
class FilterPredictor(nn.Module):
    ...
    def predict_filter(self, train_feat, test_feat, train_label, train_ltrb_target, *args, **kwargs):
        ...
        # bat 3
        # print("test_feat.shape", test_feat.shape) # [1, 3, 256, 18, 18]   
        # print("train_feat.shape", train_feat.shape) # [2, 3, 256, 18, 18] 
        # print("train_label.shape", train_label.shape) # [2, 3, 18, 18] 
        # print("train_ltrb_target.shape", train_ltrb_target.shape) # [2, 3, 4, 18, 18] 

        # print("test_feat_seq.shape", test_feat_seq.shape) # [324, 3, 256]   
        # print("train_feat_seq.shape", train_feat_seq.shape) # [648, 3, 256] 
        # print("train_label_seq.shape", train_label_seq.shape) # [648, 3, 1] 
        # print("train_ltrb_target_seq_T.shape", train_ltrb_target_seq_T.shape) # [3, 4, 648] 

        # print("test_pos.shape", test_pos.shape) # [324, 3, 256] 
        # print("train_pos.shape", train_pos.shape) # [648, 3, 256] 
        
        # print("fg_token.shape", fg_token.shape) # [1, 1, 256] 
        # print("train_label_enc.shape", train_label_enc.shape) # [648, 3, 256] 
        # print("train_ltrb_target_enc.shape", train_ltrb_target_enc.shape) # [648, 3, 256] 
        # input()
