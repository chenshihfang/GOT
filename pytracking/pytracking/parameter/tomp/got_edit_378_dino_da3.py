...
def parameters():
    ...
    # params.patch_max_scale_change = 2.0
    params.patch_max_scale_change_low = 2.
    params.patch_max_scale_change_high = 2.
    params.patch_max_scale_change_gate_thr = 2.
    ...
    params.net = NetWithBackbone(net_path="/path_to/GOT_Edit_378_Vast_DA3.tar", use_gpu=params.use_gpu)
