...
class LaSOTDataset(BaseDataset):
    ...
    def __init__(self, vos_mode=False, attribute=None):
        ...
        # self.sequence_list = self._get_sequence_list_A()
        # self.sequence_list = self._get_sequence_list_B()
        # self.sequence_list = self._get_sequence_list_C()
        # self.sequence_list = self._get_sequence_list_D()

        # self.sequence_list = self._get_sequence_list_1()
        # self.sequence_list = self._get_sequence_list_2()

        # self.sequence_list = self._get_sequence_list_OC()
    ...
    def _construct_sequence(self, sequence_name):
        ...
        # # Output directory
        # output_dir = "/home/sfchen94/pytrackingcsf/pytracking/pytracking/tracking_results/lasot_anno/"
        # os.makedirs(output_dir, exist_ok=True)

        # # Debugging: Print the current path being processed
        # print(f"Processing: {anno_path}")
        
        # # Extract the folder name and append '.txt'
        # parts = anno_path.split('/')
        # folder_name = parts[-2]
        ...
        #     shutil.copy(anno_path, output_path)
        #     print(f"Copied: {anno_path} to {output_path}")
        # except Exception as e:
        #     print(f"Error copying {anno_path}: {e}")
    ...
    def _get_sequence_list_OC(self):
        sequence_list = [
                'bird-2',
                'umbrella-9',
                'turtle-8',
