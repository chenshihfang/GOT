...
trackers.extend(trackerlist('tomp','got_jepa_378_cla',range(0,1),'got_jepa_378_cla')) # exp
trackers.extend(trackerlist('tomp','got_jepa_378_gpt',range(0,1),'got_jepa_378_gpt')) # exp
