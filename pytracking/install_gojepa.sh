...
### Note: Do not forget to install CoTracker manually.
...
echo "Please place the CoTracker checkpoint in:"
echo "your_path/GOT/pytracking/ltr/cotracker2/co_tracker/checkpoints/"

# Replace "your_path" with your actual project path.
COTRACKER_DIR="your_path/GOT/pytracking/ltr/cotracker2/co_tracker"

if [ ! -d "$COTRACKER_DIR" ]; then
    echo "Please set the correct CoTracker path:"
    echo "your_path/GOT/pytracking/ltr/cotracker2/co_tracker"
else
    cd "$COTRACKER_DIR" || exit 1
    pip install -e .
